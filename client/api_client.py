...
class ApiClient(object):
    ...
    def sanitize_for_serialization(self, obj):
        ...
        if isinstance(obj, dict):
            ...
            obj_dict = {
                ...
                for attr, _ in six.iteritems(obj.types)
    ...
    def __deserialize_model(self, data, klass):
        ...
        if not klass.types and not self.__hasattr(klass, "get_real_child_model"):
            return data

        kwargs = {}
        if klass.types is not None:
            for attr, attr_type in six.iteritems(klass.types):
                if (
                    data is not None
        ...
        if (
            ...
            and klass.types is not None
            and isinstance(data, dict)
        ):
            for key, value in data.items():
                if key not in klass.types:
                    instance[key] = value
